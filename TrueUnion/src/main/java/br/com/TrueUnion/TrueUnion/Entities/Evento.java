...
public class Evento {
	...
	private List<EventosDono> listaDeDonos = new ArrayList<>(); // RELACIONAMENTO COM TABELA INTERMEDIARIA
	@Column(name = "local_evento", nullable = false)
	private String local;//
	@Column(name = "data_inicio", nullable = false)
	private LocalDate dataInicio;
	@Column(name = "data_fim", nullable = false) // AMBAS DATAS COLOQUEI COMO NULLABLE = FALSE POIS NAO FAZ SENTIDO UM												// EVENTO NAO TEM INICIO NEM FIM...
	private LocalDate dataFim;
	@Column(nullable = true) // NAO NECESSARIAMENTE PRECISA DE UMA DESCRICAO, SERIA UM CAMPO NAO OBRIGATORIO								// NO SISTMEA.
	...
	public List<EventosDono> getListaDeDonos() {
		return listaDeDonos;
	}

	public void setListaDeDonos(List<EventosDono> listaDeDonos) {
		this.listaDeDonos = listaDeDonos;
	}
